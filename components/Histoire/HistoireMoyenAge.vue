<template>
    <SectionMainSloted :data="{ title: 'Le moyen âge', image: null, localImage: true }">

        <div class="histoireSectionContent h100 flex column justifyCenter gap20 pad20">
            <h2 class="histoireSubtitle"> Poullaouen est une ancienne paroisse de l’Armorique primitive. </h2>

            <p class="page-text">
                Elle englobait les territoires de Poullaouen (avec sa trève Saint-Tudec),
