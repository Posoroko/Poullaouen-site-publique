<template>
    <SectionMainSloted :data="{ title: 'Les origines', image: '/images/histoire/20220327_101151.jpg', localImage: true }">

        <div class="histoireSectionContent h100 flex column justifyCenter gap20 pad20">
            <h2 class="histoireSubtitle"> Poullaouen existe depuis l’antiquité, à l’époque gauloise. </h2>
