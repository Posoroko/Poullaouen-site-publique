<template>
    <section class="scheduleSection">
        ...
        <div class="mainWidth flex justifyStart">
            <NuxtLink to="https://www.education.gouv.fr/calendrier-scolaire-100148" target="_blank" class=" albumButton whiteAlbumButton flex alignCenter gap10"> <span class="icon">visibility</span> <b class="externalLink">Calendrier scolaire</b> </NuxtLink>
        </div>
    </section>
</template>
